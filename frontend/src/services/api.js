...
export const autoAssign = (agentIds) => api.post('/tickets/auto-assign', agentIds ? { agent_ids: agentIds } : {})
...
export const getProductivityMetrics = (params) => api.get('/agent-deep-analysis/productivity', { params })
